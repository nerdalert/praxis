...
/// `stateless` (MCP 2026-07-28, opt-in). Version and cache fields are
...
/// is compatible with the selected profile, and that `default_version`
/// appears in `supported_versions`.
