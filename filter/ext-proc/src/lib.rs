...
use praxis_proto::envoy::service::ext_proc::v3::processing_request;
...
fn extract_streamed_body(
    response: &praxis_proto::envoy::service::ext_proc::v3::BodyResponse,
) -> Option<(Vec<u8>, bool)> {
    ...
    match &bm.mutation {
        Some(praxis_proto::envoy::service::ext_proc::v3::body_mutation::Mutation::StreamedResponse(sr)) => {
            Some((sr.body.clone(), sr.end_of_stream))
        },
        _ => None,
    }
}
